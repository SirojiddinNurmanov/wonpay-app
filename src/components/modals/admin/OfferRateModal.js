        ...
        <ModalLayout buttons={buttons} {...props}>
            <div className="offer-modal-input">
                <div className="put-money-input">
                    <label>Olish:
                        <input type="number" defaultValue={props.buy_rate == 0 ? "" : props.buy_rate}
                               onChange={changeBuyRateValue} />
                    </label>
                </div>
            </div>
            ...
            <div className="offer-modal-input">
                <div className="put-money-input">
                    <label>Sotish:
                        <input type="number" defaultValue={props.sell_rate == 0 ? "" : props.sell_rate}
                               onChange={changeSellRateValue} />
                    </label>
                </div>
            </div>
        </ModalLayout>
