                ...
                <>
                    ...
                    <div className="process-owner-block">
                        <div className="process-owner">
                            <div
                                className="process-owner-name">{(query.client.first_name ? query.client.first_name : "No name") + " " + (query.client.last_name ? query.client.last_name : " ")}</div>
                        ...
                        <div className="process-rate-block">
                            ...
                            <div className="process-rate underlined"
                                 onClick={openModal}>{query.exchange_rate > 0 ? query.exchange_rate : "Kiritish"}</div>
                        </div>
                    </div>
                    <WhiteLine />
                    <div className="process-dollar-block">
                        ...
                        <div className="process-dollar-amount underlined"
                             onClick={openDollarModal}>{query.exchange_rate > 0 ? "$ " + formatAmount(query.amount / query.exchange_rate, true) : "Kiritish"}</div>
                    </div>
                        ...
                        <>
                            ...
                            <div className="process-offer-block">
                                ...
                                <Link to={"/offers/" + offer?.id}>
                                    <div
                                        className="process-title text-center underlined">{offer?.client.first_name + (offer?.client.last_name ? " " + offer?.client.last_name : "") + " / ￦" + formatAmount(offer?.amount ?? 0)}</div>
                                </Link>
