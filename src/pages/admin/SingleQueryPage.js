                        ...
                        <>
                            ...
                            <div className="process-offer-block">
                                ...
                                <Link to={"/offers/" + offer?.id}>
                                    <div className="process-title text-center underlined">{offer?.client.first_name + (offer?.client.last_name ? " " + offer?.client.last_name : "") + " / ￦" + formatAmount(offer?.amount ?? 0)}</div>
                                </Link>
